...
const Why = () => {
  return (
    <div id='why'>
        ...
        <div className="grid md:grid-cols-2 grid-cols-1 gap-1 md:gap-4 md:place-items-center md:py-28 p-5 text-left">
            <div className='md:w-96 w-auto' id='01'>
            ...
            <div className='md:w-96 w-auto' id='02'>
            ...
            <div className='md:w-96 w-auto' id='03'>
            ...
            <div className='md:w-96 w-auto' id='04'>
        ...
        <div id='client' className='space-y-16'>
            ...
            <div className='md:flex md:justify-evenly p-5 md:p-0'>
                <div className='relative p-7 w-80 h-80 border space-y-3 rounded-[20px] -z-10 bg-transparent md:block hidden'>
                ...
                <div className='md:absolute p-7 md:w-96 w-auto border space-y-3 rounded-lg z-20' id='overlap'>
                    <p className='text-[#888888] text-xs text-left'>01 FEB, 2019 | TECHNOLOGY</p>
                    <div className='flex'>
        ...
        <div className='md:flex md:justify-evenly' id="contact">
            <div className='text-left md:space-y-8 space-y-4 md:w-96 w-auto md:py-5 p-5'>
                <p className='text-[#16FCD2]'>CONTACT</p>
                <p className='md:text-2xl text-xl font-bold'>We love receiving messages from you, we are waiting for it.</p>
        ...
        <div className='md:flex md:justify-center md:p-0 p-5' id='lastSection'>
            <div className='md:flex md:justify-center bg-white bg-opacity-5 md:space-x-3 space-y-6 md:space-y-0 rounded-2xl p-6'>
                <p className='font-semibold text-xl md:w-96 w-auto text-left'>We've prepared everything, it's time for you to tell the problem</p>
