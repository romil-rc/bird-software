...
const Why = () => {
  ...
  return (
    <div id='why'>
        <p data-aos='fade-up' className='text-[#16FCD2] font-medium text-lg tracking-widest'>Why</p>
        <p data-aos='fade-up' className='font-semibold text-xl'>WHY WE ARE THE BEST?</p>
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 grid-cols-1 gap-1 sm:gap-4 md:gap-4 lg:gap-4 sm:place-items-center md:place-items-center lg:place-items-center sm:py-28 md:py-28 lg:py-28 p-5 text-left">
            <div data-aos='fade-right' className='sm:w-auto md:w-auto lg:w-96 w-auto' id='01'>
            ...
            <div data-aos='fade-left' className='sm:w-auto md:w-auto lg:w-96 w-auto' id='02'>
            ...
            <div data-aos='fade-right' className='sm:w-auto md:w-auto lg:w-96 w-auto' id='03'>
            ...
            <div data-aos='fade-left' className='sm:w-auto md:w-auto lg:w-96 w-auto' id='04'>
        ...
        <div id='client' className='space-y-16'>
            <div className='flex flex-col items-center space-y-5'>
                <p data-aos='fade-up' className='text-[#618DFF] font-medium text-lg tracking-wider'>Our Client Review</p>
                <p data-aos='fade-up' className='text-sm w-80 leading-loose'>Subscribe to our newsletter for daily/weekly update of our products and services.</p>
            </div>
            <div data-aos='fade-right' className='sm:flex sm:justify-evenly md:flex md:justify-evenly lg:flex lg:justify-evenly p-5 sm:p-0 md:p-0 lg:p-0'>
                ...
                <Tilt options={options} className='sm:absolute md:absolute lg:absolute p-7 sm:w-96 md:w-96 lg:w-96 w-auto border space-y-3 rounded-lg z-20' id='overlap'>
                    <p className='text-[#888888] text-xs text-left'>01 FEB, 2019 | TECHNOLOGY</p>
                    <div className='flex'>
                ...
                <div data-aos='fade-left' className='relative p-7 w-80 h-80 border space-y-3 rounded-[20px] -z-10 bg-transparent sm:block md:block lg:block hidden'>
                    <p className='text-[#888888] text-xs text-left'>01 FEB, 2019 | TECHNOLOGY</p>
                    <p className='text-xs font-light leading-loose'>Lorem Ipsum is simply dummy text of the printing and typesetting  text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                    <div className='flex justify-center'>
                        <img src={john} alt="" />
        ...
        <div id='neon7'>
            <img src={neon7} alt="" />
            <hr data-aos='fade-up' className='hidden sm:hidden md:block lg:block' id='hr2' />
        </div>
        <div className='sm:flex sm:justify-evenly md:flex md:justify-evenly lg:flex lg:justify-evenly' id="contact">
            <div data-aos='fade-left' className='text-left sm:space-y-8 md:space-y-8 lg:space-y-8 space-y-4 sm:w-96 md:w-96 lg:w-96 w-auto sm:py-5 md:py-5 lg:py-5 p-5'>
            ...
            <div data-aos='fade-right' className='sm:p-0 md:p-0 lg:p-0 p-5'>
                <img className='h-96 w-full' src={contactForm} alt="contactform" />
            </div>
        </div>
        <div data-aos="zoom-in" className='md:flex md:justify-center md:p-0 lg:flex lg:justify-center lg:p-0 p-5' id='lastSection'>
            <div className='md:flex md:justify-center lg:flex lg:justify-center bg-white bg-opacity-5 md:space-x-3 lg:space-x-3 space-y-6 md:space-y-0 lg:space-y-0 rounded-2xl p-6'>
                ...
                >
                    <p className='cursor-pointer inline-block px-3'>Send Quote</p>
                </motion.div>
                <motion.div className='expBtn text-left p-5 font-semibold'
                    whileHover={{
                        scale:1.1,
